function buttonAddToCart(elementId, title = '', icon = '') {
  const template = `
    <button style="font-size: 1.2rem; padding: 0.5rem; color: white; border: none; outline: none; background-image: linear-gradient(-180deg, rgb(193, 236, 81), rgb(128, 176, 42)); border-radius: 5px; z-index: 100">
